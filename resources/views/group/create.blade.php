<div class="row" id="vue">
    <div class="col-md-offset-2 col-md-8">
        <div class="panel panel-default">
            <div class="panel-heading">Create a New Site Group</div>
            <div class="panel-body">
                {!! Form::open() !!}
                    {!! Form::setSizes(2, 8, 2)->groupOpen() !!}
                        {!! Form::text('starting_path', null, [
                    ...
                    {!! Form::groupClose() !!}
                    {!! Form::groupOpen() !!}
                        {!! Form::text('starting_port', null, [], 'Starting Port') !!}
                    {!! Form::groupClose() !!}
                    {!! Form::offsetGroupOpen() !!}
                        {!! Form::submit('Add Site Group', ['class' => 'btn btn-primary']) !!}
                    {!! Form::groupClose() !!}
                {!! Form::close() !!}
            </div>
        </div>
