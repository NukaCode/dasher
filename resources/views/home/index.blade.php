<div class="ui grid" id="vue">
  ...
  <div class="four wide column" v-repeat="group: groups">
    ...
    <div class="ui horizontal link list right floated">
      @if (settingEnabled('valet'))
        <div class="item">
          <a href="/valet/create/@{{ group.id }}" class="content">
            <small>
              Create New <span class="ui green text">Valet</span> Site
            </small>
          </a>
        </div>
      @endif
      @if (settingEnabled('homestead'))
        <div class="item">
          <a href="/homestead/create/@{{ group.id }}" class="content">
            <small class="pull-right">
              Create New <span class="text-success">Homestead</span> Site
            </small>
          </a>
        </div>
      @endif
      ...
      <div class="ui segments dark">
        <div class="ui horizontal segments" v-repeat="site: group.sites | filterBy search | orderBy 'name'">
          <div class="ui segment" v-if="site.homesteadFlag == 0">
            <a href="http://@{{ site.url }}/" target="_blank" class="ui left floated">
              <span class="ui grey text">@{{ site.package }}</span>
              {{--<span>@{{ site.displayPort | portSpaces }}</span>--}}
              <span v-if="site.package_length == 0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
              <span v-if="site.package_length == 1">&nbsp;&nbsp;</span>
